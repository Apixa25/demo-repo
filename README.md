# EVALUATING AND MODIFYING A WEB PAGE TO IMPLEMENT ACCESSIBILITY STANDARDS WITHOUT CHANGING THE LOOK OF THE PAGE
...
Next the CSS style sheet was went through and ineficiencies were looked for and corrected.  There were several places where the CSS was redundant.  If not fixed this can cause the page to load slower than necessarry. 
